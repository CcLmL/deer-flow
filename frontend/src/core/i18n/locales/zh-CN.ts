...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 🦌 小犀，一个完全开源的超级智能体。通过内置和自定义的 Skills，\n小犀 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 小犀 的潜力。通过自定义技能，小犀\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    voiceInputStart:
      "语音输入。小犀 只接收转写文本，音频由浏览器或系统语音服务处理。",
  ...
  agents: {
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 小犀 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      buzz: "通过 小犀 智能体接收 Buzz 频道消息和私聊。",
      telegram: "通过 小犀 Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 小犀 Bot 接收 Discord 服务器消息。",
      feishu: "通过 小犀 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 小犀 Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 小犀 Bot 接收微信 iLink 消息。",
      wecom: "通过 小犀 AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 小犀 中使用",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 小犀。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 小犀 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "小犀 会在后台不断从你的对话中自动学习。这些记忆能帮助 小犀 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 小犀 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 小犀 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "小犀 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，小犀 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
